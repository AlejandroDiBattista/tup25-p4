...
# DEBUG: Procesando item de output:
#{
#      'type': 'reasoning', 
#      'id': 'rs_02e46bbb4ff86003006907c6e0f3d8819487cd617829fbc7ae', 
#      'content': None, 
...
# }
# 
# Caso A: Item de tipo reasoning con summary como lista
# DEBUG: Procesando item de output: 
# {
#      'type': 'message'
#      'id': 'msg_02e46bbb4ff86003006907c6ebb3d48194aeefa0045bf6100f', 
#      'content': [
#          {'annotations': [], 
#           'text': 'def render_ui():\n    import streamlit as st\n\n    st.title("Formulario")\n\n    with st.form("form_datos"):\n        nombre = st.text_input("Nombre")\n        apellido = st.text_input("Apellido")\n        edad = st.number_input("Edad", min_value=0, step=1, value=0)\n        enviado = st.form_submit_button("Enviar")\n\n    if enviado:\n        if not nombre.strip():\n            st.error("Por favor, ingresa tu nombre.")\n        elif not apellido.strip():\n            st.error("Por favor, ingresa tu apellido.")\n        else:\n            st.success("Datos enviados correctamente.")\n            st.write(f"Nombre: {nombre}")\n            st.write(f"Apellido: {apellido}")\n            st.write(f"Edad: {edad}")', 
#           'type': 'output_text', 
#           'logprobs': []}
#          ], 
#      'role': 'assistant', 
