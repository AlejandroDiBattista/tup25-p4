    ...
    <header className="bg-white shadow-sm">
      <div className="max-w-7xl mx-auto px-4 py-6 flex items-center justify-between">
        ...
        <nav className="flex gap-3 items-center">
          <Link href="/" className="text-gray-800 hover:text-blue-600 font-medium">Productos</Link>
          <Link href="/compras" className="text-gray-700 hover:text-blue-600">Mis compras</Link>
          <Link href="/compra" className="relative text-gray-700 hover:text-blue-600">
            Carrito
          ...
          {usuario ? (
            <>
              ...
              <button
                className="bg-gray-200 text-gray-900 px-3 py-1 rounded hover:bg-gray-300"
                onClick={() => {
