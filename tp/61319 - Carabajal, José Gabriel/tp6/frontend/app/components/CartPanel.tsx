            ...
            <div className="space-y-3">
                ...
                <div key={it.producto_id} className="flex gap-3 items-start">
                    ...
                    <div className="mt-2 flex items-center gap-2">
                        <button onClick={() => dec(it.producto_id)} className="px-2 py-1 rounded-md border text-sm">
                        –
                        </button>
                        <span className="text-sm">Cantidad: {it.cantidad}</span>
                        <button onClick={() => inc(it.producto_id)} className="px-2 py-1 rounded-md border text-sm">
                        +
                        </button>
                        <button
